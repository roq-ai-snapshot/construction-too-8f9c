  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience hassle-free rentals with Construction Tool Rental - Your one-stop-shop for accessing high-quality construction tools from multiple outlets."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience hassle-free rentals with Construction Tool Rental - Your one-stop-shop for accessing high-quality construction tools from multiple outlets.`}
            </Text>
            <Box
